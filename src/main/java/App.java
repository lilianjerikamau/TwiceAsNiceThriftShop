...
import models.User;
>>>>>>> 1449d85576718906db6e663fb03d5a675a6ea759
...
public class App {
    ...
    public static void main(String[] args) { //type “psvm + tab” to autocreate this
        ...
        Sql2oUserDao animalDao = new Sql2oUserDao(sql2o);
        Sql2oCartDao cartegoryDao = new Sql2oCartDao(sql2o);
        Sql2oProductDao taskDao = new Sql2oProductDao(sql2o);
...
<<<<<<< HEAD
        ...
        get("/", (req, res) -> {
            Map<String, Object> model = new HashMap<>();
            List<Product> allCategories = taskDao.getAll();
